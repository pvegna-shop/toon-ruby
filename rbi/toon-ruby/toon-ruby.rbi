...
module Toon
  ...
  sig do
    params(
      ...
      normalize_on: T.nilable(String),
      flatten_on: T.nilable(String),
      stringify_on: T.nilable(String)
    ).returns(String)
  end
  ...
  sig do
    params(
      ...
      indent: Integer,
      strict: T::Boolean,
      destringify_on: T.nilable(String),
      unflatten_on: T.nilable(String),
      denormalize_on: T.nilable(String)
    ).returns(T.untyped)
  end
